...
ARDUINO_DIR       = /home/$(USER)/arduino/arduino-1.8.5


### USER_LIB_PATH
### Path to where the your project's libraries are stored.
USER_LIB_PATH     :=  $(realpath $(PROJECT_DIR)/libs)

ARDUINO_LIBS = arduino-lmic SPI
...
ALTERNATE_CORE_PATH = $(ARDUINO_PACKAGE_DIR)/adafruit/hardware/avr/1.4.13
##ALTERNATE_CORE_PATH += $(ARDUINO_PACKAGE_DIR)/adafruit/hardware/samd/1.2.3
